...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinPluginTest.Android.dll" comes first in this list. */
		"XamarinPluginTest.Android.dll",
		"Plugin.Test.dll",
		"FormsViewGroup.dll",
		"Plugin.Test.Abstractions.dll",
		"Plugin.Test.Android.dll",
